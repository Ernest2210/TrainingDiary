...
public class BodyServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        for(String type: BodyParam.TYPES){
            ...
            root.put(type.toLowerCase()+"List",
                    bodyParamDAO.getAllByUserId(Helper.getUser(request.getSession()).getId()));
        }
        Template tmpl = FreemarkerConfig.getConfig(this.getServletContext()).getTemplate("body.ftl");
        try {
