...
public class TrainingTemplateListServlet extends HttpServlet {
    @Override
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        Template tmpl = FreemarkerConfig.getConfig(this.getServletContext()).getTemplate("training_list.ftl");
        try {
